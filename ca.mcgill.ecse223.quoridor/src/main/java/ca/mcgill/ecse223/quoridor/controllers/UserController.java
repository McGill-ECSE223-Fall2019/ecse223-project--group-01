...
public class UserController {
     ...
     * @return          T:he operation of the method
     * @throws UnsupportedOperationException
     *
     * @Author: Jason Lau
     */
    public static boolean newUsername(Player player, String username)throws UnsupportedOperationException {
    ...
    public static boolean selectExistingUsername(Player player, String username)throws UnsupportedOperationException{
        throw new UnsupportedOperationException();
